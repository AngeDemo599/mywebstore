...
const PRICES = { MONTHLY: 5000, YEARLY: 50000 };
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        {/* PRO Plan */}
        <div className="bg-d-surface rounded-xl shadow-card border-2 border-d-text p-6 relative">
          ...
          <div className="flex bg-d-surface-secondary rounded-lg p-1 mb-4">
            ...
            >
              {t("upgrade.yearly")}
              <span className="ml-1 text-xs text-green-600 font-medium">{t("upgrade.savePercent")}</span>
            </button>
          </div>
      ...
      {requests.length > 0 && (
        <div className="mt-8">
          <h2 className="text-lg font-bold text-d-text mb-4">{t("upgrade.requestHistory")}</h2>
            ...
            <table className="w-full">
              <thead className="bg-d-surface-secondary border-b border-d-border">
                <tr>
                  ...
                  <th className="text-left px-6 py-3 text-[13px] font-[450] text-d-text normal-case">{t("common.duration")}</th>
                  <th className="text-left px-6 py-3 text-[13px] font-[450] text-d-text normal-case">{t("common.status")}</th>
                  <th className="text-left px-6 py-3 text-[13px] font-[450] text-d-text normal-case">{t("common.note")}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-d-border">
                {requests.map((req) => (
                  <tr key={req.id}>
                    ...
                    <td className="px-6 py-4 text-sm text-d-text-sub">
